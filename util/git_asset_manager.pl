...
=head1 NAME
 ...
 git_asset_manager.pl - Perl script for managing assets in a local directory and committing assets to corresponding Git repository


=head1 SYNOPSIS

 perl util/git_asset_manager.pl
