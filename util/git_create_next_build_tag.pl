...
my $branch_report_file = $manager->getBranchReportFile();
if (!defined($branch_report_file)){
    $logger->logdie("branch_report_file was not defined");
}

print "The branch report file is '$branch_report_file'\n";my $tag_report_file = $manager->getTagReportFile();

if (!defined($tag_report_file)){
    $logger->logdie("tag_report_file was not defined");
}

print "The tag report file is '$tag_report_file'\n";
