package DevelopmentUtils::Logger;
...
B<Description:> Instantiate DevelopmentUtils::Logger object

B<Parameters:> 

 %args

B<Returns:> Returns a reference to DevelopmentUtils::Logger
...
sub _initConfiguration {
    ...
    my $conf = q(
    log4perl.logger                    = sub {return DevelopmentUtils::Logger::_getLogLevel();}

    log4perl.appender.Logfile          = Log::Log4perl::Appender::File
    log4perl.appender.Logfile.filename = sub { return DevelopmentUtils::Logger::_getLogfile(); }
...
sub getInstance {
    ...
    if (!defined($instance)){
        ...
        $instance = new DevelopmentUtils::Logger(@_);
...
B<Description:> DevelopmentUtils::Logger class destructor
...
=head1 SYNOPSIS
 ...
 my $obj = DevelopmentUtils::Logger::getInstance();
